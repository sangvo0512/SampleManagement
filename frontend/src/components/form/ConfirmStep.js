            ...
            case "Borrow":
                return (
                    <Descriptions bordered column={1} size="small">
                        ...
                        <Descriptions.Item label={t("borrowDepartment")}>{formData.DepartmentID || t("notSpecified")}</Descriptions.Item>
                        <Descriptions.Item label={t("qrCount")}>{qrList.length}</Descriptions.Item>
                        <Descriptions.Item label={t("note")}>{formData.Note || t("none")}</Descriptions.Item>
                    </Descriptions>
                );
            ...
            case "Transfer":
                return (
                    <Descriptions bordered column={1} size="small">
                        ...
                        <Descriptions.Item label={t("borrowDepartment")}>{formData.DepartmentID || t("notSpecified")}</Descriptions.Item>
                        <Descriptions.Item label={t("receiver")}>{formData.ReceiverName || t("notSpecified")}</Descriptions.Item>
                        <Descriptions.Item label={t("receiverDepartment")}>{formData.ToDepartment || t("notSpecified")}</Descriptions.Item>
            ...
            case "Export":
                ...
                return (
                    <Descriptions bordered column={1} size="small">
                        ...
                        <Descriptions.Item label={t("exportDepartment")}>{formData.DepartmentID || t("notSpecified")}</Descriptions.Item>
